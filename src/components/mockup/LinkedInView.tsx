        ...
        <div className="bg-[#1b1f23] mb-2 mt-2 pt-3 pb-1">
          ...
          <div className="px-3 mb-3">
            <p className="text-sm leading-relaxed whitespace-pre-line">
              Just updated my profile picture using this amazing new tool! 🎨 The precision cropping and real-time preview across different platforms
              is a game changer. #Design #Productivity #NewProfilePic
            </p>
          </div>

          <div className="w-full bg-[#293038] flex items-center justify-center overflow-hidden mb-2">
            {image ? (
              <img src={image.url} className="w-full h-auto max-h-[500px] object-contain" alt="Post content" />
            ) : (
