      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pt-2">
        ...
        <div className="bg-[#242526] pb-2">
          ...
          <div className="w-full bg-black flex items-center justify-center overflow-hidden max-h-[400px]">
            {image ? (
              <img src={image.url} alt="Post content" className="w-full h-full object-contain" />
            ) : (
              <div className="h-64 w-full flex items-center justify-center text-[#b0b3b8]">No image</div>
            )}
          </div>
